      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <div className="relative" ref={modeMenuRef}>
          ...
          >
            ...
            <span className="font-mono text-[11px] text-primary/90">{mode}</span>
          ...
          {isModeMenuOpen && (
            <div className="absolute top-full right-0 mt-1 w-64 bg-card border border-border rounded-xl shadow-2xl p-2 z-50 text-xs">
              ...
              <div className="space-y-1 mt-1">
                {[
                  { name: 'Local · Ollama', desc: 'qwen2.5-coder:32b (Primary)', active: mode.includes('Ollama') },
                  { name: 'Local · GPU (CUDA 12.4)', desc: 'RTX 4090 / 24GB VRAM', active: mode.includes('GPU') },
                  { name: 'Swarm · Multi-Agent', desc: 'Planner + Coder + Evaluator', active: mode.includes('Agent') },
                ].map((item, idx) => (
                  <button
                    key={idx}
